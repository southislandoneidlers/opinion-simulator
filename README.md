...
- The five real walkthrough Projects `測驗用`, `測驗用-複驗`, `測驗用-專家2`,
  `測驗用-專家3`, and `測驗用-綜整` survived intact and revalidate as `valid`.
  Counted independent expert walkthroughs: 3 of 3–5 (lower bound).
...
Documentation index: `docs/README.md`; task continuity: `docs/handoffs/README.md`.
